...
const fieldTransformers = [{
  ...
  test: field => {
    var _store$getState$remot, _store$getState$remot2, _field$type$ofType2;

    const implementsNodeInterface = (_store$getState$remot = _store.default.getState().remoteSchema.typeMap.get((0, _helpers.findNamedTypeName)(field.type))) === null || _store$getState$remot === void 0 ? void 0 : (_store$getState$remot2 = _store$getState$remot.interfaces) === null || _store$getState$remot2 === void 0 ? void 0 : _store$getState$remot2.some(i => i.name === `Node`);
  ...
  transform: ({
    ...
    const normalizedTypeName = typeKind === `SCALAR` && (0, _helpers.typeIsABuiltInScalar)(field.type) ? originalTypeName : (0, _helpers.buildTypeName)(originalTypeName);
    return {
  ...
  transform: ({
    field
  }) => `[${(0, _helpers.buildTypeName)((0, _helpers.findNamedTypeName)(field.type))}!]`
}, {
  ...
  test: field => {
    var _store$getState$remot3, _store$getState$remot4;
    ...
    (_store$getState$remot3 = _store.default.getState() // get the full type for this interface
    .remoteSchema.typeMap.get((0, _helpers.findNamedTypeName)(field.type)) // filter out any excluded types
    .possibleTypes) === null || _store$getState$remot3 === void 0 ? void 0 : (_store$getState$remot4 = _store$getState$remot3.filter(possibleType => !(0, _isExcluded.typeIsExcluded)({
      pluginOptions,
      typeName: possibleType.name
    })) // if every remaining type is a Gatsby node type
    // then use this field transformer
    ) === null || _store$getState$remot4 === void 0 ? void 0 : _store$getState$remot4.every(possibleType => gatsbyNodeTypes.includes(possibleType.name)));
